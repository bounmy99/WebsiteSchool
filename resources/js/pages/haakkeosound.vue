        ...
        <div class="card">
            <div class="card-body" v-if="isLoggin">
                ...
                <div class="mb-3" v-if="!FormType">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <button type="button" class="btn" @click="UploadLogo()">
                                <img :src="image_previews" alt="" style="width:50%; height: 50%;" />
                            </button>
                            <div class="">
                ...
                <div class="row g-2 mb-5">
                    ...
                    <div v-if="!isLoggin">
                        <div class="d-flex justify-content-center mb-2 h-10">
                            <img :src="('assets/img/logo/logo/' + this.logo)" atl="" class="rounded-circle" style="width:20%">
                        </div>
    ...
    methods: {
        ...
        ContetnUpdate(id) {
            if (this.content == '') {
                ...
                this.$axios.post(`api/sound/update/content/${id}`, { content: this.content }).then((response) => {
                    this.GetData()
                }).catch((error) => {
                    console.log(error);
                })
        ...
        LogoUpdate(id) {
            ...
            this.$axios.post(`api/sound/update/logo/${id}`, Data, { headers: { "content-Type": "multipart/form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'center',
                        icon: 'success',
        ...
        uploadImages() {
            if (this.content == '') {
                ...
                this.$axios.post('api/sound/add', formData, { headers: { "Content-Type": "multipart/form-data" } }).then(response => {
        ...
        GetData(page) {
            this.$axios.get(`api/sound/getAll?page=${page}`).then((response) => {
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    if (this.selectedItems.length > 0) {
                        this.$axios.post('api/sound/deleteSelectedItems', { ids: this.selectedItems })
                            .then((response) => {
        ...
        editImages(id) {
            ...
            this.$axios.get('api/sound/edit/' + id).then((response) => {
        ...
        update(id) {
            ...
            this.$axios.post(`api/sound/update/${id}`, Data, { headers: { "content-Type": "multipart/form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'center',
                        icon: 'success',
        ...
        EditSelectedItems() {
            this.FormType = true
            this.$axios.post('api/sound/EditSelectedItems', { ids: this.selectedItems })
                .then((response) => {
