    ...
    methods: {
        ...
        ContetnUpdate(id) {
            if (this.content == '') {
                ...
                this.$axios.post(`api/people/update/content/${id}`, { content: this.content }).then((response) => {
                    this.GetData()
                }).catch((error) => {
                    console.log(error);
                })
        ...
        uploadImages() {
            if (this.content == '') {
                ...
                this.$axios.post('api/people/add', formData, { headers: { "Content-Type": "multipart/form-data" } }).then(response => {
        ...
        GetData(page) {
            this.$axios.get(`api/people/getAll?page=${page}`).then((response) => {
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    if (this.selectedItems.length > 0) {
                        this.$axios.post('api/people/deleteSelectedItems', { ids: this.selectedItems })
                            .then((response) => {
        ...
        editImages(id) {
            ...
            this.$axios.get('api/people/edit/' + id).then((response) => {
        ...
        update(id) {
            ...
            this.$axios.post(`api/people/update/${id}`, Data, { headers: { "content-Type": "multipart\form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'top-center',
                        icon: 'success',
        ...
        EditSelectedItems() {
            this.FormType = true
            this.$axios.post('api/people/EditSelectedItems', { ids: this.selectedItems })
                .then((response) => {
