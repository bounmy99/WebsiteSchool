                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer d-flex justify-content-center">
                                <button type="button" class="btn btn-primary" @click="update(this.Id_img)">ອັບເດດ</button>
                    ...
                    <div class="row" v-if="isLoggin">
                        ...
                        <div class="col-md-8 d-flex justify-content-end">
                            <button @click="EditSelectedItems" class="btn btn-success me-2"
                                :disabled="disableBtn_del">ແກ້ໄຂ</button>
                            <button @click="deleteSelectedItems" class="btn btn-danger"
                                :disabled="disableBtn_del">ລົບຮູບ</button>
                        </div>
                    </div>
    ...
    methods: {
        ...
        ContetnUpdate(id) {
            if (this.content == '') {
                ...
                this.$axios.post(`api/draw/update/content/${id}`, { content: this.content }).then((response) => {
                    this.GetData()
                }).catch((error) => {
                    console.log(error);
                })
        ...
        LogoUpdate(id) {
            ...
            this.$axios.post(`api/draw/update/logo/${id}`, Data, { headers: { "content-Type": "multipart/form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'center',
                        icon: 'success',
        ...
        uploadImages() {
            if (this.content == '') {
                ...
                this.$axios.post('api/draw/add', formData, { headers: { "Content-Type": "multipart/form-data" } }).then(response => {
        ...
        GetData(page) {
            this.$axios.get(`api/draw/getAll?page=${page}`).then((response) => {
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    if (this.selectedItems.length > 0) {
                        this.$axios.post('api/draw/deleteSelectedItems', { ids: this.selectedItems })
                            .then((response) => {
        ...
        editImages(id) {
            ...
            this.$axios.get('api/draw/edit/' + id).then((response) => {
        ...
        update(id) {
            ...
            this.$axios.post(`api/draw/update/${id}`, Data, { headers: { "content-Type": "multipart/form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'center',
                        icon: 'success',
        ...
        EditSelectedItems() {
            this.FormType = true
            this.$axios.post('api/draw/EditSelectedItems', { ids: this.selectedItems })
                .then((response) => {
