    ...
    methods: {
        ...
        ContetnUpdate(id) {
            if (this.content == '') {
                ...
                this.$axios.post(`api/music/update/content/${id}`, { content: this.content }).then((response) => {
                    this.GetData()
                }).catch((error) => {
                    console.log(error);
                })
        ...
        LogoUpdate(id) {
            ...
            this.$axios.post(`api/music/update/logo/${id}`, Data, { headers: { "content-Type": "multipart/form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'center',
                        icon: 'success',
        ...
        uploadImages() {
            if (this.content == '') {
                ...
                this.$axios.post('api/music/add', formData, { headers: { "Content-Type": "multipart/form-data" } }).then(response => {
        ...
        GetData(page) {
            this.$axios.get(`api/music/getAll?page=${page}`).then((response) => {
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    if (this.selectedItems.length > 0) {
                        this.$axios.post('api/music/deleteSelectedItems', { ids: this.selectedItems })
                            .then((response) => {
        ...
        editImages(id) {
            ...
            this.$axios.get('api/music/edit/' + id).then((response) => {
        ...
        update(id) {
            ...
            this.$axios.post(`api/music/update/${id}`, Data, { headers: { "content-Type": "multipart/form-data" } }).then((response) => {
                if (response.data) {
                    this.$swal({
                        position: 'center',
                        icon: 'success',
        ...
        EditSelectedItems() {
            this.FormType = true
            this.$axios.post('api/music/EditSelectedItems', { ids: this.selectedItems })
                .then((response) => {
